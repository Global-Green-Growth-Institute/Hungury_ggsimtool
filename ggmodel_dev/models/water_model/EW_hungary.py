__author__ = 'Sanga Lee'
__status__ = 'Pending Validation'
__translator__='Innocent & Ribeus'
...
IWW_nodes = {'Kc': {'type': 'parameter', 'unit': '1', 'name': 'Crop Factor'},
             'ICA': {'type': 'parameter', 'unit': '1000 ha', 'name': 'Cropland area actually irrigated'},
             'CI': {'type': 'variable',
                    'unit': '1',
...
MWU_nodes = {'WP': {'type': 'input', 'name': 'Water Price', 'unit': '$/15m3'},
             'GDPC': {'type': 'input', 'name': 'GDP per capita', 'unit': '$'},
             'Pop': {'type': 'input', 'name': 'Population', 'unit': 'capita'},
             'MWU': {'type': 'variable',
...
EW1_nodes = {'IWU': {'type': 'input',
             ...
             'Cr': {'type': 'variable',
                    ...
                    'unit': '1',
                    'computation': lambda PAIR, **kwargs: 1 / (1 + (PAIR / (1 - PAIR) * 0.563))
                    },
...
EW2_nodes = {
    ...
    'DW': {'type': 'input', 'unit': 'm3/year', 'name': 'Desalination Water'},
    'TW': {'type': 'input', 'unit': 'm3/year', 'name': 'Treated Wastewater'},
    'TNCW': {'type': 'variable',
...
model_properties = get_model_properties('models/water_model/EW_hungary_properties.json')
