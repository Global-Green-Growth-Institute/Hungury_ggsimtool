...
layout = html.Div(
    [
        ...
        html.Div(
            [
                html.Div([
                   # github_link_box('Green Growth Index', 'A python program to download, process and perform all the step to compute the green growth index.','https://github.com/Global-Green-Growth-Institute/Anticipe'),
                    ...
                    github_link_box('Interface', 'A Dash web application to vizualize the  simulate green growth policies of Hungary','https://github.com/Global-Green-Growth-Institute/IndexSimilationDashboard')
                    ],className="row")
